...
namespace Batch1_DET_2022
{
     class program
     {
        public static void Main()
        {
            ...
            #region "containment"
            CompanyManager m = new CompanyManager { Name = "Moni", Surname = "G", Phone = "9876543219" };
            Company company=new Company { Name="SSL",Address="Global City",Manager=m,Phone="9876589674",
